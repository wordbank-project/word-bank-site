...
export const fr: Copy = {
    ...
    download: {
        ...
        button: "Télécharger l'APK (aller sur GitHub)",
        ...
        iosLink: 'iOS',
        fdroidPre: ' arrive bientôt, et une fiche ',
        fdroidLink: 'F-Droid',
        fdroidPost: ' est prévue.',
    ...
    practice: {
        heading: 'Comprendre. Retenir.',
        sub: 'L’IA explique n’importe quelle phrase en langage simple, et une petite série de cartes-mémoire garde vos mots enregistrés bien frais.',
        analyze: {
            heading: 'Analyser une phrase',
            intro: 'Bloqué sur une phrase compliquée ? Choisissez-en une ci-dessous et voyez comment Word Bank l’explique en langage simple.',
            chipsAria: 'Exemples de phrases',
            loading: 'Analyse…',
            meaningLabel: 'Signification',
            meanings: [
                'Le comité n’a pas dit directement ce qu’il voulait dire — chacun devait deviner le vrai message derrière ses mots.',
                'Elle était prise dans une situation sans issue : quel que soit son choix, cela poserait un problème.',
                'Il s’est excusé, mais pas assez et pas assez tôt pour que cela change vraiment quelque chose.',
            ],
        },
        memory: {
            heading: 'Mémoire',
            intro: 'Parcourez vos mots enregistrés et évaluez à quel point vous connaissez chacun — un mode d’entraînement léger, pas de répétition espacée.',
            flipHint: 'Touchez pour révéler',
            cards: [
                { definition: 'Qui émet de la lumière ; brillant ou lumineux.', example: 'Le lac devenait lumineux sous la pleine lune.' },
                { definition: 'Marcher sans destination précise, souvent juste pour le plaisir.', example: 'Nous avons passé l’après-midi à flâner dans la vieille ville.' },
                { definition: 'Le point où quelque chose commence ou change ; un seuil ou une entrée.', example: 'Elle s’arrêta sur le seuil, hésitant à frapper.' },
                { definition: 'D’une manière rapide, énergique et déterminée.', example: 'Il marchait d’un pas vif pour attraper le dernier train.' },
            ],
            stillLearning: 'Encore en apprentissage',
            knewIt: 'Je savais',
            progressPre: 'Carte ',
            progressOf: ' sur ',
            roundCompleteHeading: 'Série terminée !',
            roundResultPre: 'Vous connaissiez ',
            roundResultPost: ' mots',

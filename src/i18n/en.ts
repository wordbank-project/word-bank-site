...
export const en: Copy = {
    ...
    download: {
        ...
        button: 'Download the APK (visit GitHub)',
        ...
        iosLink: 'iOS',
        fdroidPre: ' is coming, and an ',
        fdroidLink: 'F-Droid',
        fdroidPost: ' listing is planned.',
    ...
    practice: {
        heading: 'Understand it. Remember it.',
        sub: 'AI explains any sentence in plain language, and a quick flip-card round keeps your saved words fresh.',
        analyze: {
            heading: 'Analyze a sentence',
            intro: 'Stuck on a tricky sentence? Pick one below and see how Word Bank explains it in plain language.',
            chipsAria: 'Example sentences',
            loading: 'Analyzing…',
            meaningLabel: 'Meaning',
            meanings: [
                "The committee didn't say directly what they meant — people had to guess at the real message behind their words.",
                'She was stuck in a no-win situation: whichever choice she made would cause a problem.',
                'He said sorry, but not enough and not soon enough for it to make a real difference.',
            ],
        },
        memory: {
            heading: 'Memory',
            intro: 'Flip through your saved words and rate how well you know each one — a light practice mode, not spaced repetition.',
            flipHint: 'Tap to reveal',
            cards: [
                { definition: 'Giving off light; glowing or shining brightly.', example: 'The lake turned luminous under the full moon.' },
                { definition: 'To walk without a fixed destination, often just for the pleasure of it.', example: 'We spent the afternoon wandering through the old town.' },
                { definition: 'The point at which something begins or changes; a doorway or entrance.', example: 'She paused at the threshold, unsure whether to knock.' },
                { definition: 'In a quick, energetic, and purposeful way.', example: 'He walked briskly to catch the last train.' },
            ],
            ...
            roundResultPre: 'You knew ',
            roundResultPost: ' words',

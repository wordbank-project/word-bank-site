...
export const nl: Copy = {
    ...
    download: {
        ...
        button: 'Download de APK (bezoek GitHub)',
        ...
        iosLink: 'iOS',
        fdroidPre: ' volgt, en een ',
        fdroidLink: 'F-Droid',
        fdroidPost: '-vermelding staat gepland.',
    ...
    practice: {
        heading: 'Begrijp het. Onthoud het.',
        sub: 'AI legt elke zin uit in gewone taal, en een korte flitskaartenronde houdt je bewaarde woorden vers in het geheugen.',
        analyze: {
            heading: 'Analyseer een zin',
            intro: 'Vastgelopen op een lastige zin? Kies er hieronder een en zie hoe Word Bank hem in gewone taal uitlegt.',
            chipsAria: 'Voorbeeldzinnen',
            loading: 'Analyseren…',
            meaningLabel: 'Betekenis',
            meanings: [
                'De commissie zei niet rechtstreeks wat ze bedoelde — mensen moesten raden naar de echte boodschap achter hun woorden.',
                'Ze zat vast in een uitzichtloze situatie: welke keuze ze ook maakte, het zou een probleem opleveren.',
                'Hij zei sorry, maar niet genoeg en niet op tijd om nog echt verschil te maken.',
            ],
        },
        memory: {
            heading: 'Geheugen',
            intro: 'Blader door je bewaarde woorden en beoordeel hoe goed je elk woord kent — een luchtige oefenmodus, geen spaced repetition.',
            flipHint: 'Tik om te onthullen',
            cards: [
                { definition: 'Licht uitstralend; gloeiend of helder schijnend.', example: 'Het meer werd lichtgevend onder de volle maan.' },
                { definition: 'Rondlopen zonder vaste bestemming, vaak gewoon voor het plezier.', example: 'We brachten de middag door met dwalen door de oude stad.' },
                { definition: 'Het punt waarop iets begint of verandert; een drempel of ingang.', example: 'Ze aarzelde op de drempel, niet zeker of ze zou aankloppen.' },
                { definition: 'Op een snelle, energieke en doelgerichte manier.', example: 'Hij liep stevig door om de laatste trein te halen.' },
            ],
            stillLearning: 'Nog aan het leren',
            knewIt: 'Wist het',
            progressPre: 'Kaart ',
            progressOf: ' van ',
            roundCompleteHeading: 'Ronde voltooid!',
            roundResultPre: 'Je wist ',
            roundResultPost: ' woorden',
